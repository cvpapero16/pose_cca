...
class CCA(QtGui.QWidget):
    ...
    def __init__(self):
        ...
        self.init_ui()
        #ROS
        rospy.init_node('calcvel', anonymous=True)
    ...
    def output(self):
        ...
        vs1 = []
        vs2 = []
        for (v1, v2, d1, d2) in zip(self.vel1, self.vel2, self.data1, self.data2):
            vs1.append({"data":v1.tolist(), "jdata":d1.tolist()})
            vs2.append({"data":v2.tolist(), "jdata":d2.tolist()})
